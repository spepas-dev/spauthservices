...
const { ADD_GOPA } = require("../controllers/GopaController");
...
const { ADD_MEPA } = require("../controllers/MepaController");
...
router
  .route("/user/validate-forgot-password")
  .post(NoneUserCheck, VALIDATE_FORGOT_PASSWORD);
router
  .route("/user/change-password")
  .post(NoneUserCheck, VALIDATE_TOKEN, CHANGE_PASSWORD);
router
  .route("/user/refresh-token")
  .get(NoneUserCheck, REFRESH_TOKEN, REFRESH_USER_TOKEN);

//application
router
  .route("/application/create")
  .post(NoneUserCheck, VALIDATE_TOKEN, ADD_APPLICATION);
router
  .route("/application/update")
  .post(NoneUserCheck, VALIDATE_TOKEN, UPDATE_APPLICATION);
router
  .route("/application/add-menus")
  .post(NoneUserCheck, VALIDATE_TOKEN, ADD_APPLICATION_MENUS);
router
  .route("/application/all")
  .get(NoneUserCheck, VALIDATE_TOKEN, ALL_APPLICATION);

//groups

router
  .route("/group/create")
  .post(NoneUserCheck, VALIDATE_TOKEN, ADD_NEW_GROUPS);
router
  .route("/group/applications/:group_id")
  .get(NoneUserCheck, VALIDATE_TOKEN, GROUP_APPLICATIONS);
router
  .route("/group/add-groupApplication-menus")
  .post(NoneUserCheck, VALIDATE_TOKEN, ADD_APPLICATION_MENU_GROUP);
router
...
router
  ...
  .post(NoneUserCheck, VALIDATE_TOKEN, ADD_USERS_GROUPS);

//permissions
router
  .route("/permission/add")
  .post(NoneUserCheck, VALIDATE_TOKEN, ADD_PERMISSIONS);
router
  .route("/permission/all")
  .post(NoneUserCheck, VALIDATE_TOKEN, ALL_PERMISSIONS);

//role

router.route("/role/add").post(NoneUserCheck, VALIDATE_TOKEN, ADD_NEW_ROLE);
router
  .route("/role/add-role-permissions")
  .post(NoneUserCheck, VALIDATE_TOKEN, ADD_ROLE_PERMISSIONS);
router.route("/role/all").get(NoneUserCheck, VALIDATE_TOKEN, ALL_ROLE);

router
  .route("/identification/add")
  .post(NoneUserCheck, VALIDATE_TOKEN, ADD_IDENTIFICATION);
router
  .route("/identification/profile")
  .post(NoneUserCheck, VALIDATE_TOKEN, ADD_IDENTIFICATION);
router
  .route("/identification/by-user/:user_id")
  .get(NoneUserCheck, VALIDATE_TOKEN, USER_IDENTIFICATION);
router
  .route("/identification/my-identification")
  .get(NoneUserCheck, VALIDATE_TOKEN, MY_IDENTIFICATION);
...
router
  ...
  .post(NoneUserCheck, VALIDATE_TOKEN, ADD_SELLER);
...
router
  ...
  .post(NoneUserCheck, VALIDATE_TOKEN, ADD_VEHICLE);
router
  .route("/deliver/profile-vehicle")
  .post(NoneUserCheck, VALIDATE_TOKEN, ADD_VEHICLE);
router
  .route("/deliver/vehicles/:deliver_id")
